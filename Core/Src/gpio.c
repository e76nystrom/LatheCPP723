...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, PinA16_Pin|PinA17_Pin|PinA14_Pin|DbgA11_Pin
                          |Dir4_Pin|Dbg3_Pin|LED_YELLOW_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, PinA15_Pin|Pin14_Pin|Dir5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Pin17_Pin|Pin1_Pin|Dbg4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_GREEN_Pin|Dir1_Pin|LED_RED_Pin|Dir2_Pin
  ...
  GPIO_InitStruct.Pin = PinA16_Pin|PinA17_Pin|PinA14_Pin|DbgA11_Pin
                          |Dir4_Pin|Dbg3_Pin|LED_YELLOW_Pin;
  ...
  GPIO_InitStruct.Pin = B1_Pin|PinA10_Pin|PinA9_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PCPin PCPin PCPin */
  GPIO_InitStruct.Pin = PinA15_Pin|Pin14_Pin|Dir5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin */
  GPIO_InitStruct.Pin = LED_GREEN_Pin|Dir1_Pin|LED_RED_Pin|Dir2_Pin
                          |Dbg5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
